<%@ Page Language="C#" AutoEventWireup="true" CodeFile="plugmenued.aspx.cs" Inherits="microsite_plugmenued" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/inside.css?2014-03-07-1"
        media="all">
    <script type="text/javascript" async="" src="http://tj.weimob.com/wtj.js?url=http%3A%2F%2Fwww.weimob.com%2Fmicrosite%2FPlugmenued%2Faid%2F113986"></script>
    ...
    <script charset="utf-8" src="http://trust.baidu.com/vcard/v.js?siteid=3049852&amp;url=http%3A%2F%2Fwww.weimob.com%2Fmicrosite%2FPlugmenued%2Faid%2F113986&amp;source=&amp;rnd=1734289566"></script>
</head>
<!-- Plupload -->
<!--[if lte IE 9]>
                ...
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span12">
                                <h3>
                                    <i class="icon-cog"></i>编辑快捷</h3>
                            </div>
                        </div>
                        <form action="/microsite/Plugmenued/" method="post" class="form-horizontal form-validate"
                        ...
                        <div class="box-content">
                            <div class="control-group">
                                <label for="name" class="control-label">
                                    快捷名称：</label>
                                <div class="controls">
                                    <input type="text" name="name" id="name" value="" class="input-medium" data-rule-required="true">
                                </div>
                            </div>
                            <div class="control-group">
                                <label for="order" class="control-label">
                                    显示顺序：</label>
                                <div class="controls">
                                    <input type="text" name="order" class="input-mini" data-rule-required="true" value="0"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio inline">
                                        ...
                                        是</label><label class="radio inline"><input type="radio" value="0" checked="checked"
                                            name="display">否</label>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="i-cont tile-themed">
                                        <i class="icon-bullhorn" id="icon_i"></i>
                                        <input type="hidden" id="icon" name="icon" value="icon-bullhorn">
                            ...
                            <div id="res_block">
                                ...
                                <div id="r_link" class="control-group r-module ">
                                    <div class="control-group">
                                        <label class="control-label" for="source_url">
                                            页面URL</label>
                                        <div class="controls">
                                            <input type="text" id="source_url" value="" class="input-xlarge" name="link" data-rule-required="true"
                                                data-rule-url="true">
                                ...
                                <div id="r_tel" class="control-group r-module hide">
                                    <div class="control-group">
                                        <label class="control-label" for="tel">
                                            电话号码</label>
                                        <div class="controls">
                                            <input type="text" id="tel" class="input-large" name="tel" value="" data-rule-required="true">
                                ...
                                <div id="r_activity" class="control-group r-module hide">
                                    ...
                                    <div class="controls">
                                        <select id="act" name="activity_type" onchange="if (100 == $(this).val()) {$('#activity_select_box').hide(); } else {$('#activity_select_box').show(); };">
                                            <option value="17" selected="selected">微投票</option>
                                ...
                                <!-- <div id="r_map" class="control-group r-module hide">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="input-append">
                                                    <input type="text" id="suggestId" class="input-xlarge" name="place" data-rule-required="true" />
                                                ...
                                                <div id="r-result">
                                                    <input type="hidden" id="lng" name="lng" /><input type="hidden" id="lat" name="lat" /> 
                                                </div>
    ...
    <script type="text/javascript">
        ...
        */
        ...
        window.shareData = window.shareData || {
            "timeLineLink": "http://www.weimob.com/microsite/Plugmenued?aid=113986",
            "sendFriendLink": "http://www.weimob.com/microsite/Plugmenued?aid=113986",
            "weiboLink": "http://www.weimob.com/microsite/Plugmenued?aid=113986",
