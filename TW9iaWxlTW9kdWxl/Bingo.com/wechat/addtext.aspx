<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addtext.aspx.cs" Inherits="wechat_addtext" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/emotion.css?2014-03-07-1"
        media="all">
    <script type="text/javascript" async="" src="http://tj.weimob.com/wtj.js?url=http%3A%2F%2Fwww.weimob.com%2Fwechat%2Faddtext%2Faid%2F113986"></script>
...
<body>
                ...
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3>
                                    <i class="icon-edit"></i>编辑文本自定义内容</h3>
                            </div>
                            <div class="span2">
                                <a class="btn" href="Javascript:window.history.go(-1)">返回</a></div>
                        </div>
                        <div class="box-content">
                            <form action="/wechat/addtext" method="post" class="form-horizontal form-validate"
                            ...
                            <div class="control-group">
                                <label for="keyword" class="control-label">
                                    关键词：</label>
                                <div class="controls">
                                    <input type="text" name="keyword" id="keyword" data-rule-required="true" data-rule-maxlength="100"
                                        value="" class="input-xlarge" title="多个关键词请用空格格开：例如: 美丽 漂亮 好看"><br>
                                    多个关键词请用空格格开：例如: 美丽 漂亮 好看
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <input id="radio1" type="radio" name="match_type" value="1" checked="">
                                        完全匹配，用户输入的和此关键词一样才会触发!
                                    </label>
                                    <label class="radio hide">
                                        <input id="radio2" type="radio" name="match_type" value="2">
                            ...
                            <div class="control-group" id="textreply">
                                ...
                                <div class="controls">
                                    ...
                                    <span class="maroon">*</span><span class="help-inline">必填, 用户添加您的时候自动回复语；超链接添加形式，如：&lt;a
                                        href="http://www.baidu.com"&gt;百度&lt;/a&gt;</span>
                                </div>
                            </div>
                            <div class="form-actions">
                                ...
                                <button type="submit" class="btn btn-primary" id="bsubmit">
                                    保存</button>
                                <button type="button" class="btn" onclick="window.location='/wechat/addnews/aid/113986'">
                                    切换到图文模式</button>
                            </div>
                            </form>
                        </div>
    ...
    <script type="text/javascript">
        ...
        if (typeof (window.shareData) == 'undefined') {
            ...
            window.shareData = {
                "imgUrl": share_imgurl,
                "timeLineLink": "http://www.weimob.com/wechat/addtext?aid=113986",
                "sendFriendLink": "http://www.weimob.com/wechat/addtext?aid=113986",
                "weiboLink": "http://www.weimob.com/wechat/addtext?aid=113986",
