<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addnews.aspx.cs" Inherits="wechat_addnews" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/resource.css?2014-03-07-1"
        media="all">
    <script type="text/javascript" async="" src="http://tj.weimob.com/wtj.js?url=http%3A%2F%2Fwww.weimob.com%2Fwechat%2Faddnews%2Faid%2F113986"></script>
    ...
    <div id="main">
                ...
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span10">
                                <h3>
                                    <i class="icon-edit"></i>编辑图文自定义内容</h3>
                            </div>
                            <div class="span2">
                                <a class="btn" href="Javascript:window.history.go(-1)">返回</a></div>
                        </div>
                        <div class="box-content">
                            <form action="/wechat/addnews" method="post" class="form-horizontal form-validate"
                            novalidate="novalidate">
                            <div class="control-group">
                                <label for="keyword" class="control-label">
                                    关键词：</label>
                                <div class="controls">
                                    <input type="text" name="keyword" id="keyword" value="" data-rule-required="true"
                                        data-rule-maxlength="30" class="input-xlarge" title="多个关键词请用空格格开：例如: 美丽 漂亮 好看"><br>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="radio">
                                        <input type="radio" name="match_type" checked="checked" value="1">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <label class="radio inline">
                                        <input type="radio" name="show_cover" value="0">
                                        否
                                    </label>
                                </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            if (typeof (window.shareData) == 'undefined') {
                ...
                window.shareData = {
                    "imgUrl": share_imgurl,
                    "timeLineLink": "http://www.weimob.com/wechat/addnews?aid=113986",
                    "sendFriendLink": "http://www.weimob.com/wechat/addnews?aid=113986",
                    "weiboLink": "http://www.weimob.com/wechat/addnews?aid=113986",
