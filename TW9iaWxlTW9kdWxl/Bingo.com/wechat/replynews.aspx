<%@ Page Language="C#" AutoEventWireup="true" CodeFile="replynews.aspx.cs" Inherits="wechat_replynews" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/inside.css?2014-03-07-1"
        media="all">
    <script type="text/javascript" async="" src="http://tj.weimob.com/wtj.js?url=http%3A%2F%2Fwww.weimob.com%2Fwechat%2Freplynews%3Faid%3D113986"></script>
    ...
    <script charset="utf-8" src="http://trust.baidu.com/vcard/v.js?siteid=3049852&amp;url=http%3A%2F%2Fwww.weimob.com%2Fwechat%2Freplynews%3Faid%3D113986&amp;source=&amp;rnd=1232989776"></script>
</head>
<body>
    <div id="main">
                ...
                <div class="span12">
                    <div class="box">
                        <div class="box-title">
                            <div class="span8">
                                <h3>
                                    <i class="icon-table"></i>自定义图文回复信息</h3>
                            </div>
                            <div class="span4">
                        ...
                        <div class="box-content nozypadding">
                            <div class="row-fluid">
                                <div class="span8 control-group">
                                    <div class="span5">
                                        <a class="btn" href="/wechat/addnews/aid/113986"><i class="icon-plus"></i>添加</a>
                                    ...
                                    <div class="span4 datatabletool" style="display: none;">
                                        <div class="btn-group">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="with-checkbox">
                                                <input type="checkbox" name="check" value="505029">
                                            </td>
                                            <td>
                                                西湖
                                            </td>
                                            ...
                                            <td>
                                                <span class="label label-satgreen">完全</span>
                                            </td>
                                            <td>
                                                2014-04-17
                                            </td>
                                            ...
                                            <td class="hidden-480">
                                                <a href="#" class="btn" style="display: none;" rel="tooltip" title="View"><i class="icon-search">
                                                </i></a><a href="/wechat/addnews/aid/113986/tid/505029" class="btn" rel="tooltip"
                                                    title="Edit"><i class="icon-edit"></i></a><a href="javascript:void(0);" class="btn"
                                                        rel="tooltip" title="Delete" attr="delnews_113986_505029"><i class="icon-remove">
                                                        </i></a>
                                            </td>
                                        </tr>
                                    </tbody>
    ...
    <script type="text/javascript">
        ...
        if (typeof (window.shareData) == 'undefined') {
            ...
            window.shareData = {
                "imgUrl": share_imgurl,
                "timeLineLink": "http://www.weimob.com/wechat/replynews?aid=113986",
                "sendFriendLink": "http://www.weimob.com/wechat/replynews?aid=113986",
                "weiboLink": "http://www.weimob.com/wechat/replynews?aid=113986",
