                            ...
                            <div class="row-fluid">
                                <table class="table table-hover">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="/img/payment/weixin.png">
                                            </td>
                                            <td>
                                                微信支付
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="/img/payment/tenpay_direct_icon.gif">
                                            </td>
                                            <td>
                                                财付通即时到账交易（手机网站支付）
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="/img/payment/alipay_direct_icon.gif">
                                            </td>
                                            <td>
                                                支付宝即时到账交易（手机网站支付）
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <img src="/img/payment/offline_icon.gif">
                                            </td>
                                            <td>
                                                货到付款
                                            </td>
